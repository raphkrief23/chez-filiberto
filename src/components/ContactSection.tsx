...
const schedule = [
  { day: "Lundi", hours: "12h00 – 14h30 / 18h30 – 22h30" },
  { day: "Mardi", hours: "12h00 – 14h30 / 18h30 – 22h30" },
  { day: "Mercredi", hours: "12h00 – 14h30 / 18h30 – 22h30" },
  { day: "Jeudi", hours: "12h00 – 14h30 / 18h30 – 22h30" },
  { day: "Vendredi", hours: "12h00 – 14h30 / 18h30 – 22h30" },
  { day: "Samedi", hours: "12h00 – 14h30 / 18h30 – 22h30" },
  { day: "Dimanche", hours: "Fermé" },
];

const MAPS_EMBED_URL =
  "https://maps.google.com/maps?q=48.857524999999995,2.2746644&z=17&output=embed";
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          >
            ...
            <div>
              ...
              <a
                href="mailto:contact@59-rue-de-boulainvilliers.fr"
                className="text-primary font-body tracking-wide hover:text-terracotta hover:tracking-wider transition-all duration-300"
              >
                contact@59-rue-de-boulainvilliers.fr
              </a>
            </div>
          </div>
          <div
