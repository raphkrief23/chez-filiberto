...
const categories = [
  {
    ...
    items: [
      ...
      { name: "Fantastica", price: "20,00" },
      { name: "Pizza oro", price: "20,00" },
      { name: "Filiberto", price: "20,00" },
      { name: "Prato verde", price: "18,00" },
    ],
  },
  {
    title: "Calzoni",
    items: [
      { name: "Caprese", price: "15,00" },
      { name: "Prataiolo", price: "18,00" },
      { name: "Regina", price: "18,00" },
      { name: "Porcino", price: "20,00" },
    ],
  },
];
